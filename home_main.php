...
<?php include 'header.php'; ?>
  ...
  <body>
    ...
    <section class="video">
      <div class="hero">
          <div class="content">
              <h1> GO EXPLORE </h1>
              <p>Welcome to Batangas, where beautiful smiles are seen everywhere.
  ...
  <div class="iframe">
    <iframe sandbox="allow-top-navigation" src="home_carousel.html" width="100%" height="585" frameborder="0" background="transparent"></iframe>
  </div>
